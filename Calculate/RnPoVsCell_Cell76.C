...
*/
	...
	vector<double> vTotRuntime;
	vector<double> vLivetime, vPileupTime;

	vTotRuntime.push_back(totRuntime);
	vLivetime.push_back(livetime);
	vPileupTime.push_back(pileupVetoTime);
...
//\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
	...
	histFile->WriteObject(&vTotRuntime,"vTotRuntime");
